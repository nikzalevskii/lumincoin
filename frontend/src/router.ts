...
export class Router {
    ...
    private newRoute: RouteType | undefined;
    private currentRoute: RouteType | undefined;
        ...
        this.routes = [
            {
                ...
                load: () => {
                    new Layout((this.newRoute as RouteType), this.openNewRoute.bind(this));
            ...
            },
            {
                ...
                load: () => {
                    new Layout((this.newRoute as RouteType), this.openNewRoute.bind(this));
                    new Dashboard(this.openNewRoute.bind(this));
                    new PlotsWeek(this.openNewRoute.bind(this));
                },
                unload: () => {
                },
                styles: [''],
            ...
            },
            {
                ...
                load: () => {
                    new Layout((this.newRoute as RouteType), this.openNewRoute.bind(this));
                    new Dashboard(this.openNewRoute.bind(this));
                    new PlotsMonth(this.openNewRoute.bind(this));
                },
                unload: () => {
                },
                styles: [''],
            ...
            },
            {
                ...
                load: () => {
                    new Layout((this.newRoute as RouteType), this.openNewRoute.bind(this));
                    new Dashboard(this.openNewRoute.bind(this));
                    new PlotsYear(this.openNewRoute.bind(this));
                },
                unload: () => {
                },
                styles: [''],
            ...
            },
            {
                ...
                load: () => {
                    new Layout((this.newRoute as RouteType), this.openNewRoute.bind(this));
                    new Dashboard(this.openNewRoute.bind(this));
                    new PlotsAllPeriod(this.openNewRoute.bind(this));
                },
                unload: () => {
                },
                styles: [''],
            ...
            },
            {
                ...
                load: () => {
                    new Layout((this.newRoute as RouteType), this.openNewRoute.bind(this));
                    new Dashboard(this.openNewRoute.bind(this));
                    new PlotsInterval(this.openNewRoute.bind(this));
                },
                unload: () => {
                },
                styles: [''],
    ...
    private async activateRoute(e?:Event| Element | null, oldRoute?:string | null):Promise<void> {
        if (!this.inProgress) {
            this.inProgress = true;

            if (oldRoute) {
                this.currentRoute = this.routes.find((item: RouteType) => item.route === oldRoute);
            ...
            if (this.newRoute) {
                if (this.newRoute.styles && this.newRoute.styles.length > 0 && this.newRoute.styles[0] !== '') {
                    this.newRoute.styles.forEach(style => {
                        FileService.loadPageStyle('/css/' + style, this.bootstrapStyleElement as HTMLElement)
                    });
                }
                    ...
                    if (this.newRoute.useLayout) {
                        if (!this.currentRoute || !this.currentRoute.useLayout) {
                            if (this.contentPageElement) {
                                this.contentPageElement.innerHTML = await fetch((this.newRoute.useLayout as string)).then(response => response.text());
                            }
                        }
                        contentBlock = document.getElementById('content-layout');
                    }
                    (contentBlock as HTMLElement).innerHTML = await fetch((this.newRoute.filePathTemplate as string)).then(response => response.text());
                ...
                if (userInfo && accessToken) {
                    ...
                    if (this.profileNameElement) {
                        this.profileNameElement.innerText = (userInfo as UserInfoType).name + ' ' + (userInfo as UserInfoType).lastName;
                    }
